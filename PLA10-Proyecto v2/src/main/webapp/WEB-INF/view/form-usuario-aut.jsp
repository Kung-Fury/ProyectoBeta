...
<!-- 				    <option value="ROLE_EMPLEADO" selected>EMPLEADO</option> -->
<!-- 				    <option value="ROLE_GERENTE">GERENTE</option>  -->
<!-- 				    <option value="ROLE_ADMIN">ADMINISTRADOR</option>  -->
<!-- 			  	</select> -->
			</div>

			<form:form action="saveauthority" modelAttribute="authority" method="post">
			<div>
					<label for="authority">Autoridad:</label>
					<select name="authority" class="form-control">
					    <option value="ROLE_EMPLEADO" selected>EMPLEADO</option>
...
<!-- 				<input type="submit" value="Guardar" class="btn btn-success" /> -->
			...
			<br>
<!-- 			<input type="button" onclick="myFunction()" value="Guardar" class="btn btn-success" /> -->
			<a href="${pageContext.request.contextPath}/admin/index-usuarios"
				class="btn btn-outline-primary float-right"> Volver a lista de
				usuarios</a>
		</form:form>
		
		<input type="button" onclick="submitForms()" value="Guardar" class="btn btn-success" />
